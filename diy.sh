...
my_scripts_list_2="jd_entertainment.js z_marketLottery.js z_unionPoster.js z_wish.js z_mother_jump.js z_oneplus.js z_lenovo.js z_mgold.js z_super5g.js z_grassy.js z_sister.js z_getJDCookie.js"
...
cd /jd/config
echo -e "开始更新 diy.sh "
wget -q --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/hocyushing/jd/main/diy.sh -O diy.sh.new
if [ $? -eq 0 ]; then
